      ...
      <Button
        ...
        onClick={handleDialog(
          <div>
            <div className="p-3">
              <p>
                Replace or be replaced. But that is OK, there shouldn't be open
                more than one document. Also, dialog body is completaly unstyled
                so style content in your component.
              </p>
              <p>
                You can provide close handling function through component props.
              </p>
            </div>
            <div className="p-3">
